...
const Products = () => {
    return (
        <div className="flex bg-[#1B2022] lg:w-[1920px] lg:h-[982px] md:w-full md:h-[700px] sm:h-[2000px] sm:w-auto  relative" id="products" >
            {/*Head content div*/}
            <div className="flex flox-row ml-[10px]">
            <div style={{ borderTop: "6px solid #FC5723 ",}} className="lg:w-[581px] lg:ml-[181px] lg:mt-[10px] sm:w-[80px] sm:mt-[20px] sm:mr-[5px]">
            </div>
            <div className="text-center lg:text-[51px] lg:ml-[30px] lg:mt-[-30px] lg:mr-[30px] sm:text-[30px]">PRODUCTS</div>
            <div style={{ borderTop: "6px solid #FC5723 ",}} className="lg:w-[581px] lg:mr-[181px] lg:mt-[10px] sm:w-[90px] sm:mt-[20px] sm:ml-[5px]"></div>
            </div>
            ...
            <div className="lg:flex lg:flex-row lg:space-x-[-900px] lg:mt-[30px] sm:flex sm:flex-col sm:space-y-[700px]">
                ...
                <div className="lg:h-[396px] lg:w-[396px] lg:mt-[85px] lg:ml-[-1650px] lg:mb-[99px] bg-[#282F35] rounded-[20px] border-4 border-[#707070] sm:h-[300px] sm:w-[300px] sm:ml-[-300px] sm:mt-[100px]" data-aos="fade-right" data-aos-delay="100" data-aos-duration="2000">
                    ...
                    {/*End of first image div*/}
                        ...
                        <a href="https://univel.io/"><button className="bg-[#FC5723] lg:text-[25px] text-black text-center rounded-[50px] lg:w-[554px] 
                        lg:h-[83px] lg:ml-[-60px] lg:space-x-[35px] lg:mt-[40px] sm:h-[60px] sm:w-[260px] sm:mt-[180px] sm:ml-[20px] hover:bg-white" data-aos="fade-right" data-aos-delay="100" data-aos-duration="2000">
                ...
                <div className="lg:h-[396px] lg:w-[396px] lg:mt-[110px] lg:ml-[-650px] lg:mb-[99px] bg-[#282F35] rounded-[20px] border-4 border-[#707070] sm:h-[300px] sm:w-[300px] sm:ml-[-300px] sm:mt-[1100px]" data-aos="fade-left" data-aos-delay="100" data-aos-duration="2000">
                    ...
                    <p className="lg:text-[35px] text-white font-bold lg:ml-[130px] lg:mt-[-240px] sm:mt-[30px] sm:ml-[70px]" data-aos="fade-left" data-aos-delay="100" data-aos-duration="2000">GRIFFIN ART</p>
                        ...
                        <a href="https://griffinart.finance/"><button className="bg-[#FC5723] lg:text-[25px] text-black text-center rounded-[50px] lg:w-[554px] 
                        lg:h-[83px] lg:ml-[-60px] lg:space-x-[35px] lg:mt-[40px] sm:h-[60px] sm:w-[260px] sm:mt-[80px] sm:ml-[20px] hover:bg-white" data-aos="fade-left" data-aos-delay="100" data-aos-duration="2000">
