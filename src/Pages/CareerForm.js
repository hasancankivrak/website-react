...
const CareerForm = () => {
    ...
    return (
        <>
            <SecondNav />
            <div className="lg:w-[1920px] lg:h-[1399px] bg-[#1B2022] relative sm:w-auto sm:h-auto">
                <div className="flex flox-row ml-[10px]">
                    <div style={{ borderTop: "6px solid #FC5723 ", }} className="lg:w-[581px] lg:ml-[181px] lg:mt-[140px] sm:w-[110px] sm:mt-[110px] sm:mr-[5px]">
                    </div>
                    <div className="text-center lg:text-[51px] lg:ml-[30px] lg:mt-[100px] lg:mr-[30px] sm:text-[30px] sm:mt-[90px]">CAREER</div>
                    <div style={{ borderTop: "6px solid #FC5723 ", }} className="lg:w-[581px] lg:mr-[181px] lg:mt-[140px] sm:w-[110px] sm:mt-[110px] sm:ml-[5px]"></div>
                </div>
                <div className="">
                    <form ref={form} onSubmit={sendEmail} className="lg:ml-[293px] lg:flex lg:flex-row lg:space-x-[85px] lg:mt-[-190px] sm:flex-col sm:ml-[85px] sm:mt-[20px]">
                        ...
                        {/*Button div*/}
                        <div>
                            <button type="submit" className="bg-[#FC5723]  text-black font-bold hover:bg-white lg:rounded-[50px] lg:text-[37px] lg:w-[312px] lg:h-[111px] lg:ml-[-940px] lg:mt-[890px] sm:ml-[10px] sm:mt-[30px] sm:h-[50px] sm:w-[200px] sm:rounded-[40px]">Apply now</button>
                        </div>
                    </form>
                </div>
                {/*Line div*/}
