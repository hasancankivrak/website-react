...
const CareerPage = () => {
  return (
    <>
      <SecondNav />
      <div className="lg:w-[1920px] lg:h-[982px] lg:bg-[#0A2C59] sm:bg-[#1B2022] relative sm:w-auto sm:h-auto">
        {/*Content div*/}
        {/*Header*/}
        <div className="flex flox-row ml-[10px]">
                <div style={{ borderTop: "6px solid #1FACD7 ", }} className="lg:w-[581px] lg:ml-[181px] lg:mt-[180px] sm:w-[50px] sm:mt-[120px] sm:mr-[15px]">
                </div>
                <div className="text-center lg:text-[30px] lg:ml-[30px] lg:mr-[30px] lg:mt-[155px] sm:text-[20px] sm:mt-[110px]">WE ARE LOOKING FOR </div>
        ...
        <div className="lg:flex lg:flex-row lg:space-x-[40px] sm:flex sm:flex-col sm:space-y-[10px]">
          {/*First image div*/}
          <Link to="/CareerForm">
            <div className="lg:h-[448px] lg:w-[448px] lg:mt-[150px] lg:ml-[120px] lg:mb-[99px] lg:bg-[#0A3E78] sm:bg-[#282F35] lg:rounded-[20px] sm:h-[300px] sm:w-[300px] sm:ml-[30px] sm:mt-[90px] sm:rounded-[20px]">
              {/*Image div*/}
        ...
        {/*End Of Line div*/}
        {/*Copyright div*/}
        <div className="lg:h-[231] lg:w-[1920] lg:bg-[#0A2C59] sm:bg-[#1B2022] lg:mt-[-30px] sm:w-auto sm:w-auto">
